...
<body onload="startTimer()">
    ...
    window.onbeforeunload = function() { if(question_no!=max_questions){return "Warning: Seu trabalho será perdido!!";} };
    ...
    $(document).ready(function(){
        $.get('getQuestionDAO.jsp?question_no='+question_no+'&req=first',function(data,status){
            ...
            question_id=obj.id;
            $('#question').html('<b>Questão '+question_no+': </b><br/>'+obj.question);
        ...
        $('#next').click(function(){
            ...
            if(s==0){
        		alert("Selecione a resposta para esta pergunta");
        	}
        	else{
        	question_no++;
